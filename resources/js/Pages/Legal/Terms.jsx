                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 sm:p-12">
                    ...
                    <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
                        ...
                        <section>
                            ...
                            <p className="mb-2">El usuario se compromete a no utilizar Qran para:</p>
                            <ul className="list-disc list-inside space-y-1.5 pl-2">
                        ...
                        <section>
                            ...
                            <p>Qran se presta «tal cual» y «según disponibilidad». El titular no garantiza una disponibilidad del 100% y podrá interrumpir el servicio por mantenimiento, actualizaciones o causas de fuerza mayor. Se intentará notificar las interrupciones planificadas con antelación razonable.</p>
                        </section>

                        <section>
                            <h2 className="text-base font-semibold text-gray-900 mb-3">6. Contenido del usuario</h2>
                            <p>Los QR codes, URLs de destino y configuraciones creados por el usuario son de su exclusiva responsabilidad. El usuario garantiza que dispone de todos los derechos necesarios sobre las URLs y contenidos enlazados. Qran actúa como mero intermediario técnico y no supervisa el contenido de los destinos enlazados.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>En la máxima medida permitida por la ley aplicable, Qran no será responsable de daños indirectos, incidentales, especiales o consecuentes derivados del uso o imposibilidad de uso del servicio. La responsabilidad total máxima frente a un usuario no superará el importe abonado por el servicio en los últimos 3 meses o <strong>50 €</strong>, lo que sea mayor.</p>
                        </section>
