    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-500 text-sm mt-1">Gratis para siempre, sin tarjeta de crédito</p>
            </div>
            ...
            <form onSubmit={submit} className="space-y-4">
                ...
                <div className="group">
                    ...
                    <div className="relative">
                        <User size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 transition-colors group-focus-within:text-black" />
                        <input
                            type="text"
                            value={data.name}
                    ...
                    {errors.name && (
                        <p className="text-red-500 text-xs mt-1.5 animate-in fade-in slide-in-from-top-1 duration-200">{errors.name}</p>
                    )}
                </div>
                ...
                <div className="group">
                    ...
                    {errors.email && (
                        <p className="text-red-500 text-xs mt-1.5 animate-in fade-in slide-in-from-top-1 duration-200">{errors.email}</p>
                    )}
                </div>
                ...
                <div className="group">
                    ...
                    {errors.password && (
                        <p className="text-red-500 text-xs mt-1.5 animate-in fade-in slide-in-from-top-1 duration-200">{errors.password}</p>
                    )}
                </div>
                ...
                <div className="group">
                    ...
                    {errors.password_confirmation && (
                        <p className="text-red-500 text-xs mt-1.5 animate-in fade-in slide-in-from-top-1 duration-200">{errors.password_confirmation}</p>
                    )}
                </div>
            ...
            <p className="mt-6 text-center text-sm text-gray-500">
                ¿Ya tienes cuenta?{' '}
                <Link href={route('login')} className="text-black font-medium hover:underline underline-offset-2">
                    Inicia sesión
                </Link>
            </p>
        </GuestLayout>
